...
public class JsonWriterTest extends JsonTest {
    ...
    void testWriterWorldManyEventsFrames() {
        try {
            ...
            RelativeFrame frame2 = world.getRelativeFrames().get(0).boost("Frame2", 0.9);
            ...
            world = reader.read();
            assertEquals(2, world.getRelativeFrames().size());
        ...
        } catch (IOException | NameInUseException | FasterThanLightException e) {
            fail("Exception should not have been thrown");
        }
    }
}
